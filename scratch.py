...
github_repo_url = os.getenv('GIT_REPO_URL')
...
pm_message = """
Can you change the shape of the submit button with a more rounded corners?
"""
...
async def call_claude(PM_prompt: str):
        ...
        if isinstance(message, UserMessage):
            ...
            for block in message.content:
                ...
                if isinstance(block, TextBlock):
                    TextBlock_msg.append(block.text)
...
if __name__ == "__main__":
    ...
    asyncio.run(call_claude(pm_message))
